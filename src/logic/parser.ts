...
// Function to parse from the email headers and get name and email
...
// Function to parse the List-Unsubscribe header and extract HTTP and mailto links, as well as check for one-click unsubscribe
